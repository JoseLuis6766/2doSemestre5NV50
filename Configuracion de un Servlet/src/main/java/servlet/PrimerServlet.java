...
public class PrimerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewServlet1 </h1>");
            out.println("<div>");
            ...
            while(ParameterNames.hasMoreElements()){
                String pName = ParameterNames.nexElement();
                out.println("<li>"+pName+"="+ getServletContext().getInitParameter(pName)+"</li>");
            }
            out.print("<p>Lista de parametros iniciales del servlet</p>");
            Enumeration<String> initParamNames = getInitParameterNames();
             while(initParamNames.hasMoreElements()){
                String pName = initParamNames.nexElement();
